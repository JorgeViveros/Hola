...
var _Carrusel = __webpack_require__(76);
...
(0, _reactDom.render)(_react2.default.createElement(
  ...
  null,
  _react2.default.createElement(_Carrusel2.default, { data: _data2.default })
...
var _VideoWrapper = __webpack_require__(77);
...
var Carrusel = function (_Component) {
	_inherits(Carrusel, _Component);

	function Carrusel(props) {
		_classCallCheck(this, Carrusel);

		var _this = _possibleConstructorReturn(this, (Carrusel.__proto__ || Object.getPrototypeOf(Carrusel)).call(this, props));

		_this.state = {
			activeID: 0,
			videoSelected: _this.props.data[0].srcvideo,
			panelStyle: {
	...
	_createClass(Carrusel, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'section',
				{ className: 'wrapper' },
				_react2.default.createElement(_Selectors2.default, {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"video",
					{
						...
						"data-setup": "{}" },
					_react2.default.createElement("source", { src: this.props.data.srcvideo, type: "application/x-mpegURL" })
				)
			);
		}
	}]);
...
var _Vid = __webpack_require__(80);
...
var Selectors = function (_Component) {
	_inherits(Selectors, _Component);

	function Selectors() {
		_classCallCheck(this, Selectors);

		return _possibleConstructorReturn(this, (Selectors.__proto__ || Object.getPrototypeOf(Selectors)).apply(this, arguments));
	}
				...
				this.props.data.map(function (item) {
					return _react2.default.createElement(
						...
						_react2.default.createElement(Selector, {
							key: item.id,
							id: item.id,
							_handleClick: _this2._handleClick,
							_changeActive: _this2.props._changeActive,
							activeID: _this2.props.activeID,
							header: item.header
						})
					);
				})
...
var Selector = function (_Component2) {
	_inherits(Selector, _Component2);
...
var Etiqueta = function Etiqueta(_ref2) {
